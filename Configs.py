class Config:
    def __init__(self, layer_sizes, layer_num_genes, population_size, mutation_prob, num_selected, num_generations):
...
pong = Config(layer_sizes=[64 ** 2, 640, 64], layer_num_genes=[500, 250, 250, 250], population_size=2000,
              mutation_prob=0, num_selected=80, num_generations=100000)

mnist_small = Config(layer_sizes=[784, 128, 64], layer_num_genes=[75, 75, 50, 25], population_size=250,
                     mutation_prob=0.02, num_selected=25, num_generations=100000)
